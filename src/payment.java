...
public class payment extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            ResultSet rs1 = st.executeQuery("SELECT * FROM payment INNER JOIN member ON payment.id = member.id WHERE payment.month='" + month + "' AND payment.id='" + id + "'");

            while(rs1.next())
            {
                jButton3.setVisible(false);
                JOptionPane.showMessageDialog(null, "payment is already done for these month.");
            }
        }
        catch(Exception e)
        {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            ps.executeUpdate();
            tableDetails();
            JOptionPane.showMessageDialog(null, "successfully paied");
            setVisible(false);
            new payment().setVisible(true);
