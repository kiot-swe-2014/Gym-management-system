...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Amount to pay/mounth");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Connection con=ConnectionProvider.getcon();
            PreparedStatement ps=con.prepareStatement("update member set fullname=?,mobilenumber=?, email=?,`unique id`=?, age=?,amount=? where id=? ");
